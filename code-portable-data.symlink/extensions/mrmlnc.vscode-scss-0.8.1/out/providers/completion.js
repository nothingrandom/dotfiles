 ...
 * Do Completion :)
 */
function doCompletion(document, offset, settings, storage) {
    ...
    if (settings.suggestVariables && isVariableContext) {
        symbolsList.forEach(symbols => {
            ...
            const fsPath = document_1.getDocumentPath(documentPath, isImplicitlyImport ? symbols.filepath : symbols.document);
