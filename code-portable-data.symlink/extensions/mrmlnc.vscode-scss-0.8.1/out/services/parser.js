...
function parseDocument(document, offset = null, settings) {
    const symbols = Object.assign(Object.assign({}, getDocumentSymbols(document, settings)), { document: vscode_languageserver_1.Files.uriToFilePath(document.uri) || document.uri, filepath: vscode_languageserver_1.Files.uriToFilePath(document.uri) || document.uri });
...
function getDocumentSymbols(document, settings) {
    try {
        return symbols_1.findSymbols(document.getText());
    }
    catch (err) {
